...
class __TwigTemplate_61313e5003fd3677f56f993d7fa43d29 extends Template
{
...
($context["is_top_level_menu"] ?? null) && CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/workspaces/back-end-exam/web/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
